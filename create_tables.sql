...
ALTER TABLE Tache_archivee ADD CONSTRAINT FK_TACHE_ARCH_REF FOREIGN KEY (ref_tache) REFERENCES Tache (ref_tache);
ALTER TABLE Tache_archivee ADD CONSTRAINT FK_TACHE_ARCH_REF_REFUTILISATEUR FOREIGN KEY (ref_utilisateur) REFERENCES Utilisateur (ref_utilisateur);
ALTER TABLE Tache_archivee ADD CONSTRAINT FK_TACHE_ARCH_REFPERIODICITE FOREIGN KEY (ref_periodicite) REFERENCES Periodicite (ref_periodicite);
